...
public class FileSplitter {
  //  C:\Users\Heydari\IdeaProjects\phase1NLP2\src
    public String tokenizer(String fileName) throws IOException {
        ...
        file = new PrintWriter(new BufferedWriter(new  FileWriter("C:/Users/Heydari/IdeaProjects/phase1NLP2/src/"+fileName+"tokens")));
        String temp ="";
        String file_line;
    ...
    public String sentenceBreaker(String filename) throws IOException {
        PrintWriter file = null;
        file = new PrintWriter(new BufferedWriter(new  FileWriter("sentences")));
        //  file.close();
