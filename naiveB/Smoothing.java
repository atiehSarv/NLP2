...
public  class Smoothing{
    ...
    public String counter(String inputfile) throws FileNotFoundException, IOException {
        ...
        file = new PrintWriter(new BufferedWriter(new  FileWriter(  "D:/NLP/pr2/src/"+inputfile+"countWordsMap")));
    ...
    public void probabilityFile(String inputFile) throws IOException {
        ...
        probFile = new PrintWriter(new BufferedWriter(new  FileWriter(  "D:/NLP/pr2/src/"+inputFile+"probSmooth")));
        counter(inputFile);
        int wordNumbers;
        HashMap<String , Integer> map = new HashMap<String ,Integer>();
